...
INSERT INTO Enrollments (enrollment_id, student_id, course_id, status, progress, enrollment_date) VALUES
    ...
    -- ADDED: To make Student 3 (Mariam) fully complete for Happy Path & RAG scenarios
    (28, 3,  1, 'completed', 100, '2026-01-10'),
    (29, 3,  2, 'completed', 100, '2026-01-15');
...
INSERT INTO Grades (grade_id, student_id, assignment_id, score, graded_by) VALUES
    ...
    (2,  2, 1, 92, 1),
    (3,  2, 3, 78, 2),
    -- Student 3 (Mariam) grades adjusted for a clear Data Science dominance
    (4,  3, 5, 95, 3),   -- ML: 95
    (5,  3, 8, 100, 5),  -- DB: 100
    (6,  3, 9, 100, 5),  -- DB: 100
    (7,  5, 3, 70, 2),
    ...
    (13, 2, 10, 88, 6),
    (14, 6, 11, 91, 6),
    (15, 3, 12, 50, 7),  -- Node.js: 50 (lowered to hurt Web/SWE tracks)
    (16, 9, 13, 85, 7),
    (17, 5, 14, 82, 8),
    (18, 4, 16, 90, 9),
    (19, 3, 18, 100, 3), -- Data Viz: 100 (boosted)
    (20, 6, 19, 87, 3),
    (21, 2, 20, 80, 10),
    (22, 3, 1,  100, 1), -- Python: 100
    (23, 3, 3,  50, 2);  -- DSA: 50 (lowered to hurt SWE track)
